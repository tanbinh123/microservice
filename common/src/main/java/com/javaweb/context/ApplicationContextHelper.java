...
public class ApplicationContextHelper implements ApplicationContextAware { 
    ...
    //AbstractRoutingDataSource abstractRoutingDataSource = (AbstractRoutingDataSource) ApplicationContextHelper.getApplicationContext().getBean("multipleDataSourceManage");
