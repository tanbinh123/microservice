...
public final class ApiConstant {
	...
	public static final String USER_MODULE_ASSIGNMENT = "/userModuleAssignment";//用户模块分配接口
	...
	public static final String ROLE_LIST_ALL = "/listAll";//角色列表接口
	
	public static final String WEB_ROLE_RESTRICT_PREFIX = "/web/sys/roleRestrict";
	public static final String ROLE_RESTRICT_ADD = "/add";//新增角色限定接口
	public static final String ROLE_RESTRICT_LIST = "/list";//查询角色限定接口
	public static final String ROLE_RESTRICT_MODIFY = "/modify";//修改角色限定接口
	public static final String ROLE_RESTRICT_DETAIL = "/detail/{roleRestrictId}";//角色限定详情接口
	public static final String ROLE_RESTRICT_DELETE = "/delete/{roleRestrictId}";//删除角色限定接口
	public static final String ROLE_RESTRICT_PROVINCE = "/getProvince";//获得省信息接口（角色限定）
	public static final String ROLE_RESTRICT_CITY = "/getCity/{provinceCode}";//获得市信息接口（角色限定）
	public static final String ROLE_RESTRICT_DISTRICT = "/getDistrict/{cityCode}";//获得区信息接口（角色限定）
	...
	public static final String WEB_CONFIG_PREFIX = "/web/sys/config";
	public static final String CONFIG_ADD = "/add";//新增配置接口
	public static final String CONFIG_LIST = "/list";//查询配置接口
	public static final String CONFIG_MODIFY = "/modify";//修改配置接口
	public static final String CONFIG_DETAIL = "/detail/{configId}";//配置详情接口
	public static final String CONFIG_DELETE = "/delete/{configId}";//删除配置接口
	...
	public static final String DB_TABLES_REDUCTION = "/reduction";//数据库表还原
	public static final String DB_TABLES_OPERATE = "/operate";//数据库操作
