...
public class Module extends BaseEntity implements Serializable {
	...
	@Column(name="api_sign",columnDesc="API的SIGN")
	private String apiSign;//API的SIGN
	
	@Column(name="parent_id",columnDesc="模块的上级ID")
	private String parentId;//模块的上级ID
	
	/** 该字段设想是存储着树型结构某条分支的完整链路，形如1-6-12，表示该条数据的上级ID是12，12的上级ID是6，6的上级ID是1，此类存储mongodb是种解决方案 */
