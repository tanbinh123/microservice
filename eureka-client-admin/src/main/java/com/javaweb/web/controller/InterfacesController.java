...
public class InterfacesController extends BaseService {

	@PostMapping(ApiConstant.INTERFACES_LIST)
	@ControllerMethod(interfaceName="接口列表接口",auth=AuthEnum.PERMISSION)
	...
	@ControllerMethod(interfaceName="接口详情接口",auth=AuthEnum.PERMISSION)
	...
	@ControllerMethod(interfaceName="修改接口接口",auth=AuthEnum.PERMISSION)
	public BaseResponseResult interfacesModify(@RequestBody Interfaces interfaces,@TokenDataAnnotation TokenData tokenData){
		...
		interfaces.setUpdateDate(new Date());
		...
		stringRedisTemplate.convertAndSend(SystemConstant.INTERFACES_TOPIC,SystemConstant.INTERFACES_TOPIC);
	...
	@ControllerMethod(interfaceName="用户角色数据权限接口",auth=AuthEnum.PERMISSION)
	...
	@ControllerMethod(interfaceName="数据权限分配接口",auth=AuthEnum.PERMISSION)
	...
	@ControllerMethod(interfaceName="接口测试接口",auth=AuthEnum.PERMISSION)
