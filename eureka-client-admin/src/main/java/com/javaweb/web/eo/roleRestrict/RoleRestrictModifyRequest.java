...
@Getter
@Setter
public class RoleRestrictModifyRequest implements Serializable {

	private static final long serialVersionUID = 8475135720503902811L;
	
	@NotEmpty(message="validated.roleRestrict.id.notEmpty")
