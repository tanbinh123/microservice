...
# 一、项目启动说明          
当新建一个纯净的项目引入common只需要排除默认数据源配置即可：@SpringBootApplication(exclude={DataSourceAutoConfiguration.class})    
1、angular-admin    
...
2、本项目默认使用自己“造的轮子”——数据库通用CRUD接口，还有很多不足    
...
如果读取war包的话参考integration-demo里的pom.xml    
